...
export function UpdatePrompt() {
  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 bg-[var(--bg-elevated)] border border-[var(--brand-border)] rounded-xl shadow-lg shadow-black/30 p-4 animate-fade-in-up z-50">
      <div className="flex items-start gap-3">
        <svg className="w-5 h-5 text-[var(--brand)] shrink-0 mt-0.5" viewBox="0 0 24 24" fill="currentColor">
          ...
          {progress !== null ? (
            ...
            <div className="flex gap-2 mt-3">
              <button
                ...
                className="px-3.5 py-1.5 rounded-lg bg-[var(--brand)] text-[var(--on-brand)] text-[12px] font-semibold hover:bg-[var(--brand-hover)] transition-colors duration-100 active:scale-[0.97]"
              >
